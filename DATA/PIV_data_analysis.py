...
for k in range(1, 1000):
    filename = f'DATA/sample_{k:04d}_converted.csv'
...
plt.colorbar()
plt.title('U_rms over 100 Samples')
plt.xlabel('x/d')
plt.ylabel('y/d')
...
plt.colorbar()
plt.title('U_rms over 1000 Samples')
plt.xlabel('x/d')
plt.ylabel('y/d')
...
plt.colorbar()
plt.title('V_rms over 100 Samples')
plt.xlabel('x/d')
plt.ylabel('y/d')
...
plt.colorbar()
plt.title('V_rms over 1000 Samples')
plt.xlabel('x/d')
plt.ylabel('y/d')

plt.savefig('velocity_statistics.png')
plt.tight_layout()
plt.show()

plt.figure(figsize=(10, 5))
plt.subplot(1, 2, 1)
plt.plot(xnd, u_rms_100[:, 95] / u_sonic, label= 'U_rms at y/d=0')
plt.plot(xnd, u_rms_100[:, 62] / u_sonic, label= 'U_rms at y/d=0.5')
plt.title('U_rms vs x (100 samples)')
plt.xlabel('x/d')
plt.ylabel('U_rms / U_sonic')
plt.legend()

plt.subplot(1, 2, 2)
plt.plot(xnd, u_rms_1000[:, 95] / u_sonic, label= 'U_rms at y/d=0')
plt.plot(xnd, u_rms_1000[:, 62] / u_sonic, label= 'U_rms at y/d=0.5')
plt.title('U_rms vs x (1000 samples)')
plt.xlabel('x/d')
plt.ylabel('U_rms / U_sonic')
plt.legend()

plt.savefig('u_mean_profiles.png')
plt.tight_layout()
plt.show()
...
plt.savefig('sonic_curve and shock location.png')
plt.tight_layout()
plt.show()